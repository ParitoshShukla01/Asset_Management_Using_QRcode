...
Our application is developed using Firebase, Android studio & Quick Response system that works towards making the field data collection process tasks easier, quicker and more accurate.Given below the QR codes can be opened in a new tab or downloaded and scanned for the demo.
